  ...
  module Testing
    class PerformanceTest < ActiveSupport::TestCase
      ...
      def test_environment_format_without_rails
        ...
        assert_match "#{RUBY_ENGINE}-#{RUBY_VERSION}.#{RUBY_PATCHLEVEL},#{RUBY_PLATFORM}", benchmarker.environment
      end
      ...
      def test_environment_format_with_rails
        ...
        metric = ActiveSupport::Testing::Performance::Metrics[:time].new
        benchmarker = ActiveSupport::Testing::Performance::Benchmarker.new(self, metric)
        assert_match "rails-4.0.0,#{RUBY_ENGINE}-#{RUBY_VERSION}.#{RUBY_PATCHLEVEL},#{RUBY_PLATFORM}", benchmarker.environment
      ensure
